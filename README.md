...
| 7/7 | 优惠券秒杀 · 分布式锁 |
| 7/8 | 秒杀优化 · 消息队列 |
| 7/9 | JavaSE 入门六篇 · JavaWeb 全套 15 篇 · 达人探店 |
| 7/10 – 7/15 | 休息 6 天 |
...
| 7/27 | IO 流进阶深化（P94→P110，缓冲流·转换流·序列化·打印流） |
| 7/28 | IO 流扫尾 · 多线程/JUC · 网络编程（P110→P168） |
| 7/29 | JavaSE 完结 P168→P200（反射·动态代理）· 补写 Redis 短信登录笔记 |
| 7/30 | 补写网络编程·反射·动态代理笔记 · Redis 实战篇完结（好友关注·GEO·签到·UV统计） |
| 8/2 | Redis 高级篇开始（持久化 RDB·AOF · 主从复制） |
| 8/3 | Redis 高级篇（哨兵 · 分片集群） |
